import {
  Heart, Wind, Anchor, Coins, Crosshair, Users,
  Package, TrendingUp, Skull
} from 'lucide-react';
...
export default function HUD({ gameState, onToggleCrew }: HUDProps) {
    ...
    <div className="absolute inset-0 z-20 pointer-events-none">
      ...
      <div className="absolute top-0 left-0 right-0 flex justify-between items-start p-3">
        ...
        <div className="bg-[#0F1F2E]/80 backdrop-blur-sm rounded-lg p-3 border border-[#D4A843]/20 pointer-events-auto">
          ...
          <div className="text-center text-xs text-[#A3B8CC] mt-1">
            {gameState.wind.speed.toFixed(0)} knots
          </div>
        </div>

        {/* Center - Combat indicator */}
          ...
          <div className="flex flex-col items-center gap-2">
            ...
            <div className="flex gap-2 pointer-events-auto">
              <button
                ...
                className="bg-[#1A3C5A]/90 hover:bg-[#1A3C5A] border border-[#D4A843]/30 rounded-lg p-2 transition-all hover:scale-110"
                title="Crew Panel (C)"
              >
